...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/track_min_distance.c', 'src/yarkovsky_effect.c', 'src/radiation_forces.c', 'src/integrate_force.c', 'src/modify_orbits_forces.c', 'src/type_I_migration.c', 'src/rebxtools.c', 'src/gr.c', 'src/core.c', 'src/integrator_euler.c', 'src/linkedlist.c', 'src/stochastic_forces.c', 'src/modify_mass.c', 'src/gr_potential.c', 'src/gas_damping_timescale.c', 'src/lense_thirring.c', 'src/interpolation.c', 'src/integrator_implicit_midpoint.c', 'src/central_force.c', 'src/gas_dynamical_friction.c', 'src/tides_constant_time_lag.c', 'src/integrator_rk2.c', 'src/output.c', 'src/inner_disk_edge.c', 'src/gravitational_harmonics.c', 'src/gr_full.c', 'src/integrator_rk4.c', 'src/modify_orbits_direct.c', 'src/input.c', 'src/tides_spin.c', 'src/steppers.c', 'src/exponential_migration.c'],
