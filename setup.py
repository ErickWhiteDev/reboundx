...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/integrator_euler.c', 'src/integrate_force.c', 'src/stochastic_forces.c', 'src/gr_potential.c', 'src/tides_dynamical.c', 'src/input.c', 'src/gr.c', 'src/central_force.c', 'src/core.c', 'src/rebxtools.c', 'src/gas_damping_timescale.c', 'src/steppers.c', 'src/modify_orbits_forces.c', 'src/modify_mass.c', 'src/yarkovsky_effect.c', 'src/interpolation.c', 'src/modify_orbits_direct.c', 'src/type_I_migration.c', 'src/track_min_distance.c', 'src/inner_disk_edge.c', 'src/lense_thirring.c', 'src/exponential_migration.c', 'src/linkedlist.c', 'src/tides_constant_time_lag.c', 'src/gravitational_harmonics.c', 'src/integrator_rk4.c', 'src/gas_dynamical_friction.c', 'src/radiation_forces.c', 'src/integrator_implicit_midpoint.c', 'src/integrator_rk2.c', 'src/tides_spin.c', 'src/gr_full.c', 'src/output.c'],
